    ...
    public function getPortfolioProjects(): array
    {
        return [
            [
                ...
                'tags' => ['PHP', 'Symfony', 'Laravel', 'MySQL', 'OpenSearch', 'Docker', 'Herd', 'CI/CD', 'PHPUnit', 'Architecture Hexagonale', 'Livewire', 'Alpine.js', 'Vue.js', 'Tailwind CSS'],
                'order' => 1,
            ...
            [
                ...
                'tags' => ['PHP', 'Symfony', 'MySQL', 'Docker', 'CI/CD', 'Stimulus', 'Saas'],
                'order' => 2,
            ...
            [
                ...
                'tags' => ['PHP', 'Symfony', 'MySQL', 'Docker', 'CI/CD', 'PHPUnit', 'JavaScript', 'Bootstrap'],
                'order' => 4,
            ...
            [
                ...
                'tags' => ['PHP', 'Symfony', 'MySQL', 'Docker', 'CI/CD'],
                'order' => 5,
            ...
            [
                ...
                'tags' => ['PHP', 'Symfony', 'MySQL', 'Docker', 'CI/CD', 'JavaScript', 'Sass'],
                'order' => 6,
            ...
            [
                ...
                'tags' => ['PHP', 'MySQL', 'JavaScript', 'Docker', 'CI/CD', 'MVC'],
                'order' => 7,
