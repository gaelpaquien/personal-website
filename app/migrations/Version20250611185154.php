...
final class Version20250611185154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        <h2>Audit complet</h2>
        <p>Dans un premier temps, j\'ai réalisé un audit complet de l\'application pour identifier les points d\'amélioration. Cet audit s\'est appuyé sur des outils spécialisés : Codacy pour analyser la qualité du code (complexité, duplication, standards de codage) et New Relic pour évaluer les performances de l\'application en conditions réelles.</p>
        <h2>Réduction dette technique</h2>
        <p>Suite à l\'audit, j\'ai entrepris une réduction significative de la dette technique en migrant l\'application de Symfony 5 vers Symfony 7. Cette migration majeure nécessitait de comprendre les breaking changes, adapter le code aux nouvelles versions des composants et s\'assurer de la compatibilité avec les dépendances.</p>
        <h2>Nouvelles fonctionnalités</h2>
        <p>J\'ai également développé de nouvelles fonctionnalités pour améliorer la gestion des tâches. Mise en place d\'une commande pour identifier et associer les tâches sans auteur à un utilisateur anonyme, avec la possibilité pour les administrateurs de gérer le statut de ces tâches anonymes.</p>
        <h2>Suite de tests</h2>
        <p>Pour garantir la stabilité de l\'application après les modifications, j\'ai mis en place une suite de tests fonctionnels complète avec PHPUnit. L\'objectif était d\'obtenir une couverture de tests totale de l\'application, assurant ainsi la non-régression des fonctionnalités existantes.</p>
        <h2>Environnement moderne</h2>
        <p>J\'ai modernisé l\'environnement de développement en mettant en place Docker pour faciliter le développement et le déploiement, ainsi qu\'une pipeline CI/CD avec GitHub Actions pour automatiser les déploiements.</p>
        <h2>Conclusion</h2>
        ...
        <p>Initially, I performed a complete audit of the application to identify improvement points. This audit relied on specialized tools: Codacy to analyze code quality (complexity, duplication, coding standards) and New Relic to evaluate application performance under real conditions.</p>
        <h2>Technical Debt Reduction</h2>
        <p>Following the audit, I undertook a significant reduction of technical debt by migrating the application from Symfony 5 to Symfony 7. This major migration required understanding breaking changes, adapting code to new component versions and ensuring compatibility with dependencies.</p>
        <h2>New Features</h2>
        <p>I also developed new features to improve task management. Implementation of a command to identify and associate tasks without authors to an anonymous user, with the ability for administrators to manage the status of these anonymous tasks.</p>
        <h2>Test Suite</h2>
        <p>To guarantee application stability after modifications, I implemented a complete functional test suite with PHPUnit. The objective was to achieve total test coverage of the application, thus ensuring non-regression of existing functionalities.</p>
        <h2>Modern Environment</h2>
        <p>I modernized the development environment by implementing Docker to facilitate development and deployment, as well as a CI/CD pipeline with GitHub Actions to automate deployments.</p>
        <h2>Conclusion</h2>
        ...
        $this->addSql("INSERT INTO articles (
            ...
            'Audit et optimisation de ToDo & Co : migration Symfony 5 vers 7, suite de tests PHPUnit complète avec couverture totale et réduction de la dette technique.',
            'Audit and optimization of ToDo & Co: Symfony 5 to 7 migration, complete PHPUnit test suite with full coverage and technical debt reduction.',
