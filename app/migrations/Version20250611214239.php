...
final class Version20250611214239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       <p>J\'ai conçu le design en répondant spécifiquement aux attentes du client et à l\'identité de son entreprise. En complément du site, j\'ai également créé une <strong>carte de visite et un flyer</strong> en respectant la direction artistique du site pour assurer une cohérence visuelle complète. Le développement a nécessité du CSS et JavaScript custom pour répondre aux besoins particuliers du projet. Le site intègre également un <strong>formulaire de contact optimisé</strong> pour faciliter la prise de contact avec les prospects.</p>
       <h2>Configuration technique</h2>
       <p>Au-delà du développement, j\'ai configuré la <strong>boîte mail professionnelle</strong> pour le client, assurant ainsi une communication professionnelle cohérente avec l\'image de marque de l\'entreprise.</p>
       <h2>Impact business</h2>
       <p>Ce site a permis au client d\'attirer ses <strong>premiers prospects et de développer son activité</strong>, générant les premiers leads qualifiés d\'une petite entreprise locale.</p>
       <h2>Conclusion</h2>
       ...
       <p>I designed the layout specifically responding to client expectations and company identity. In addition to the website, I also created a <strong>business card and flyer</strong> following the site\'s artistic direction to ensure complete visual consistency. Development required custom CSS and JavaScript to meet the project\'s specific needs. The site also integrates an <strong>optimized contact form</strong> to facilitate prospect contact.</p>
       <h2>Technical Configuration</h2>
       <p>Beyond development, I configured the <strong>professional email box</strong> for the client, ensuring professional communication consistent with the company\'s brand image.</p>
       <h2>Business Impact</h2>
       <p>This website allowed the client to attract their <strong>first prospects and develop their business</strong>, generating the first qualified leads for a small local company.</p>
       <h2>Conclusion</h2>
       ...
       <p>In my <strong><a href="/en/blog/my-symfony-personal-website-wordpress-migration-to-a-modern-application">next article</a></strong>, radical context change: discover the complete redesign of my personal website with a WordPress to Symfony migration.</p>';
        ...
        $this->addSql("INSERT INTO articles (
           ...
           'rg-clean-car-site-vitrine-wordpress-pour-entreprise-de-nettoyage-automobile',
           'rg-clean-car-wordpress-showcase-website-for-automotive-cleaning-company',
           'Développement complet du site vitrine WordPress de RG Clean Car : design sur mesure, configuration email pro, ayant généré les premiers leads qualifiés pour une petite entreprise locale.',
           'Complete development of RG Clean Car WordPress showcase website: custom design, professional email setup, which generated the first qualified leads for a small local business.',
